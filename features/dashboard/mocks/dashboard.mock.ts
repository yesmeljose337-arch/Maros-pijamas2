...
export const mockTopProducts: TopProduct[] = [
  { id: "1", name: "Pijama Satín Beige", sales: 42, emoji: "🌙" },
  { id: "2", name: "Conjunto Algodón Marfil", sales: 35, emoji: "☁️" },
  { id: "3", name: "Bata Verde Oliva", sales: 28, emoji: "🫒" },
  { id: "4", name: "Pijama Estampado Navideño", sales: 21, emoji: "✨" },
  { id: "5", name: "Set Dorado Premium", sales: 17, emoji: "🌟" },
];
